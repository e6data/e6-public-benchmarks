...
def create_query_mapping(
    stats1: Dict, stats2: Dict, engine1: str, engine2: str
...
if __name__ == "__main__":
    ...
    test_path = "s3://your-s3-bucket/jmeter-results/engine=e6data/cluster_size=S-4x4/benchmark=tpcds_29_1tb/run_type=concurrency_2/"
