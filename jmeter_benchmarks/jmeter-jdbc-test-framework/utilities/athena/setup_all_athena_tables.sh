...
echo "=========================================="
echo ""
echo "1. Migrate existing data to jmeter_run_metadata:"
echo "   ./utilities/athena/scripts/bulk_migrate_metadata.sh e6data S-2x2 tpcds_29_1tb"
echo ""
echo "2. Query tables using WORKING_QUERIES.sql:"
